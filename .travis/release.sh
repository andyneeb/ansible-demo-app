...
tower-cli job_template associate_notification_template --job-template "Release Demo App v$TRAVIS_BUILD_NUMBER" --notification-template 1 --status=error
tower-cli job_template associate_notification_template --job-template "Release Demo App v$TRAVIS_BUILD_NUMBER" --notification-template 1 --status=success
