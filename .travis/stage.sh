...
tower-cli workflow_job launch -W 58 --extra-vars=instance_image=rhel76openjdk18 --extra-vars=instance_name=stage --extra-vars=app_release=$TRAVIS_BRANCH --monitor
