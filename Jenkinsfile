node ('master') {
   ...
   stage('Stage') {
      ...
      withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'tower', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) sh 'tower-cli config username $USERNAME && tower-cli config password $PASSWORD'
